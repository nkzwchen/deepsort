...
if __name__ == '__main__':
	# 读取图片
	orgimg = cv2.imread(r'D:\Project\Monet_traffic\data\photo\1.png')
	...
	cv2.imwrite(r"D:\Project\Monet_traffic\data\photo\2.jpg", cropped)
	#框出车牌
	cv2.rectangle(img, (rect[0], rect[1]), (rect[2], rect[3]), (0,255,0),2)
	
	cv2.imwrite(r"D:\Project\Monet_traffic\data\photo\3.jpg", img)
